...
class VersionBumper:
    ...
    def parse_version(self, version_str: str) -> dict[str, Any]:
        ...
        Returns:
            Dictionary with version components: major, minor, patch, pre_release_type,
            pre_release_num
    ...
    def bump_version(self, current: str, bump_type: str, pre_release: str | None = None) -> str:
        ...
        self.logger.info(
            "Bumped version %s -> %s (bump_type=%s, pre_release=%s)",
            current,
            new_version,
            bump_type,
            pre_release,
    ...
    def execute_bump(self, bump_type: str, pre_release: str | None = None) -> str:
