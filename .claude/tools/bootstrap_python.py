...
''')
    ...
    def bootstrap_python_project(self) -> bool:
        ...
        steps = [
            ...
            (
                "Copy Python CLAUDE.md standards",
                lambda: self.common.copy_language_specific_claude_md("python"),
            ),
...
Examples:
  ...
  python .claude/tools/bootstrap_python.py --package web_service --install --create-venv
  python .claude/tools/bootstrap_python.py --package api_service --author "John Doe" \\
    --include-fastapi
        """,
    )
