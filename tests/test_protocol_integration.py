...
from morsecode.pipeline.container import Container, get_container, configure_global_container
...
class TestComponentFactory:
    ...
    def test_factory_creates_audio_source(self):
    ...
    def test_factory_creates_signal_processor(self):
    ...
    def test_factory_creates_decoder(self):
...
class TestContainer:
    ...
    def test_container_basic_usage(self):
    ...
    def test_container_singleton_behavior(self):
        ...
        audio1 = container.resolve(AudioSource)
        audio2 = container.resolve(AudioSource)

        # Should be same instance
        assert audio1 is audio2

        # Resolve with singleton=False
        audio3 = container.resolve(AudioSource, singleton=False)

        # Should be different instance
        assert audio1 is not audio3

    def test_container_requires_configuration(self):
    ...
    def test_container_handles_unknown_type(self):
        ...
        with pytest.raises(ValueError, match="Unknown component type"):
            container.resolve(str)  # type: ignore[type-abstract]

    def test_container_clear_singletons(self):
...
class TestGlobalContainer:
    ...
    def test_configure_global_container(self):
...
class TestProtocolCompliance:
    ...
    def setup_method(self):
        ...
        self.audio_config = {"sample_rate_hz": 44100, "chunk_size_ms": 20}
        self.signal_config = {
            "target_frequency_hz": 600.0,
            "detection_threshold": 0.5,
            "filter_bandwidth_hz": 100.0,
    ...
    def test_audio_source_protocol_compliance(self):
    ...
    def test_signal_processor_protocol_compliance(self):
    ...
    def test_decoder_protocol_compliance(self):
    ...
    def test_end_to_end_protocol_usage(self):
