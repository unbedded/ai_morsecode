...
class ASCIIDebugDisplay(ConfigurableBase):
    ...
    def _load_config_values(self) -> None:
        ...
        self.chunk_size_ms = self._cfg_section.get_int(DebugDisplayCfgKey.CHUNK_SIZE_MS)
        self.convolution_interval_ms = self._cfg_section.get_int(DebugDisplayCfgKey.CONVOLUTION_INTERVAL_MS)

        # STEP 1: Load playback speed for time synchronization
        self.playback_speed = self._cfg_section.get_double(DebugDisplayCfgKey.PLAYBACK_SPEED)
